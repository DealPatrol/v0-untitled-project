...
import { User, Calendar, Upload, FileText, Users, ArrowLeft, ArrowRight, CheckCircle, Sparkles } from "lucide-react"
...
export default function CreateSampleMemorialPage() {
  ...
  const handleSubmit = async () => {
    ...
    const memorialId = `SAMPLE-${Date.now()}`

    toast({
      title: "Sample Memorial Created!",
      description: `Your sample memorial has been created with ID: ${memorialId}`,
    })

    setIsSubmitting(false)

    // Redirect to sample memorial view
    router.push(`/sample-memorial-created?id=${memorialId}`)
  }
      ...
      <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white py-3">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center gap-2">
            ...
            <span className="font-semibold">Sample Memorial Creation</span>
            <span>• No Payment Required • For Demo Purposes</span>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-slate-900 mb-2">Create Sample Memorial</h1>
              <p className="text-slate-600">
                Step {currentStep} of {steps.length}: {steps[currentStep - 1].title}
              </p>
              <p className="text-sm text-purple-600 mt-2">
                This is a demo version - no payment required. Perfect for testing and showcasing.
              </p>
            </div>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="Teacher, Engineer, Artist, etc."
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      rows={3}
                      placeholder="Gardening, reading, traveling, cooking..."
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      rows={3}
                      placeholder="Awards, volunteer work, career highlights..."
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="A meaningful quote or personal motto"
                    />
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  ...
                  <p className="text-sm text-slate-600">
                    Sample Memorial: Unlimited photos and videos for demo purposes
                  </p>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <Input
                      ...
                      required
                    />
                    <p className="text-sm text-slate-500 mt-1">Main photo that will appear on the memorial</p>
                  </div>
                  ...
                  <div>
                    ...
                    />
                    <p className="text-sm text-slate-500 mt-1">{formData.videos.length} videos uploaded</p>
                  </div>
                </CardContent>
              </Card>
            )}
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <Textarea
                      ...
                      rows={6}
                      placeholder="Tell us about their life, personality, and what made them special. Include their background, career, family life, and the impact they had on others..."
                      required
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      rows={4}
                      placeholder="Share a special memory or story that captures who they were. This could be a favorite family tradition, a funny story, or a moment that shows their character..."
                    />
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      rows={2}
                      placeholder="Michael Smith, Sarah Johnson, David Smith..."
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="Robert and Helen Smith"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      rows={2}
                      placeholder="James Smith, Lisa Brown, Mark Smith..."
                    />
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  <div className="bg-slate-50 p-6 rounded-lg">
                    <h3 className="font-semibold text-lg mb-4">Sample Memorial Summary</h3>
                    <div className="space-y-2 text-sm">
                      ...
                      <div>
                        <strong>Type:</strong> Sample Memorial (Demo)
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-2">
                      ...
                      />
                      <Label htmlFor="isPublic">Make sample memorial publicly accessible</Label>
                    </div>
                  ...
                  <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
                    <div className="flex items-center gap-2 text-purple-700 mb-2">
                      <Sparkles className="w-5 h-5" />
                      <span className="font-semibold">Sample Memorial Notice</span>
                    </div>
                    <p className="text-sm text-purple-600">
                      This is a demo memorial for testing and showcase purposes. No payment is required. The memorial
                      will be marked as a sample and can be used for demonstrations.
                    </p>
                  </div>
                </CardContent>
              </Card>
